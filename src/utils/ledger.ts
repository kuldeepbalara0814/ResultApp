...
import { Target, Wallet, Landmark, TrendingUp, Edit2, Trash2, Settings, BarChart2, Activity, Download, X, Flag } from 'lucide-react';
...
export default function TrackerTab() {
  ...
  // ==========================================
  // [UPDATED] Target Calculations based on 50/50 Rule
  // ==========================================
  // चूँकि 50% पैसा Bank में जाता है, इसलिए हमारा असली टारगेट प्रोग्रेस 'Safe Bank' का बैलेंस है।
