...
// --- स्वागत मिशन कंपोनेंट (Welcome Mission Component) ---
        ...
        <div className="bg-[#0b171e] p-5 rounded-3xl border border-[#008080]/40 shadow-[0_8px_20px_rgba(0,128,128,0.15)] text-center animate-in fade-in zoom-in duration-500">
            ...
            <div className="text-left text-slate-300 text-[13px] space-y-3.5 leading-relaxed">
                <p className="flex items-start gap-2">
                    ...
                    <span>
                        <strong className="text-white">हम कोई सट्टा प्लेटफार्म या वॉलेट नहीं हैं:</strong> यहाँ न कोई UPI पेमेंट है, न कोई OTP। आपका पैसा आपके पास, आपके खुद के बैंक खाते में पूरी तरह सुरक्षित है।
                    </span>
                </p>
                <p className="flex items-start gap-2">
                    <span className="text-base mt-0.5">🛡️</span>
                    <span>
                        <strong className="text-white">ऑपरेटर के जाल से सुरक्षा:</strong> 1964 से चला आ रहा '10 के 900' का लालच आज AI ऑपरेटरों के ज़रिए आपको लूट रहा है। यह सिस्टम आपको 'अमीर' बनाने का झूठा लालच नहीं देता, बल्कि आपको <span className="text-[#e6007a] font-bold">"रोड पर आने" से बचाता है</span>।
                    </span>
                </p>
                <p className="flex items-start gap-2">
                    <span className="text-base mt-0.5">🤝</span>
            ...
            <p className="text-[11px] text-slate-400 italic">
                "जुए और सट्टे के नशे को मैनेजमेंट में बदलिए"
            </p>
        </div>
    );
};
