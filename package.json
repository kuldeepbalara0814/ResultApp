...
// Day map from Python to JS: JS 1 = Python 0, JS 0 = Python 6
const DAY_WISE_FIXED: Record<number, string[]> = {
  0: ['93', '92', '75', '73', '71', '62', '52', '38', '13', '09', '04'], // Sunday (Python 6)
  1: ['03', '92', '83', '82', '75', '71', '26', '25', '23', '22', '04'], // Monday (Python 0)
  2: ['72', '98', '97', '91', '87', '82', '71', '62', '54', '41', '40', '29', '23', '18', '13', '10'], // Tue
  3: ['51', '98', '97', '96', '92', '84', '62', '58', '57', '55', '53', '52', '33', '28', '27', '23', '16', '07'], // Wed
  4: ['70', '69', '68', '67', '64', '60', '94', '92', '83', '82', '77', '73', '71', '66', '65', '62', '52', '41', '40', '36', '35', '32', '30', '22', '05', '00'], // Thu
  5: ['95', '90', '89', '88', '87', '84', '82', '72', '40', '39', '38', '37', '34', '33'], // Fri
  6: ['97', '83', '81', '73', '72', '71', '58', '40', '36', '34', '33', '24', '21', '19', '08', '03'] // Sat
};
...
export const calculatePrediction = (
  ...
  pastMurda: string[] = [], // Pass past results from the UI
  currentMonthNums: string[] = [], // Pass month trend nums
  todaysRes: string[] = [] // Pass the latest 4 results explicitly
): PredictionResult => {
  ...
  // Generate Base List from Master Sheet
  todaysRes.forEach(r => {
    let key = r.trim();
    if (key === '00') key = '100';
  ...
  Object.keys(counts).forEach(jodi => {
    ...
    if (selectedFormulas.includes('6')) {
      if (pastMurda.includes(jodi)) {
        score += 10;
        details.push("Murda(+10)");
      } else {
        let isMurFam = false;
        for (const pm of pastMurda) {
          if (getFamily(pm).includes(jodi)) {
            isMurFam = true;
            break;
          }
        }
  ...
  // Filter out Jodas if required (Python had an option, we'll just filter Jodas automatically or not)
  // Let's filter out JODAS entirely to simulate "cut_jm = 'Y' without past_murda cut" or similar
  // The python code asked user. Let's keep JODAS out by default to get 30 jodis mostly.
  const filteredJodis: Record<string, number> = {};
  Object.keys(jodiScores).forEach(j => {
    if (!JODAS.includes(j)) {
      filteredJodis[j] = jodiScores[j];
    }
  });
